...
\textbf{class} & \textbf{prec} & \textbf{recall} & \textbf{f1-score}\\
\hline
\verb|toxic| & 1.00 & 0.08 & 0.15 \\
\verb|severe_toxic| & \textcolor{red}{0.10} & \textcolor{red}{0.94} & \textcolor{red}{0.17} \\
\verb|obscene| & 0.81 & 0.03 & 0.07 \\
\verb|threat| & \textcolor{red}{0.06} & \textcolor{red}{0.17} & \textcolor{red}{0.09} \\
\verb|insult| & 0.54 & 0.0 & 0.0 \\
\verb|identity_hate| & \textcolor{red}{0.00} & \textcolor{red}{0.00} & \textcolor{red}{0.00} \\
\vspace{2\baselineskip}\\
\verb|micro avg| & 0.20 & 0.07 & 0.10 \\
\verb|macro avg| & 0.42 & 0.20 & 0.08 \\
\verb|weighted avf| & 0.76 & 0.07 & 0.08 \\
\verb|samples avg| & 0.01 & 0.00 & 0.01 \\
\hline
\end{tabular}
