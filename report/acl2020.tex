...
\subsection{T5}
We used T5-small on the unbalanced training dataset similar to BERT. As part of the multilabel classification a language modeling head is used on top of the decoder. The model was run 2 epochs with 8 and 16 batch size. We saw 
