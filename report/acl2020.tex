...
Once T5 didn't give an improvement over Bert, we examined models that use a different approach to pre-training and implemented XLNet, which is an auto-regressive based model that does a better job of learning dependency pairs.
